...
class Form extends Component {
  ...
  handleSubmit = async e => {
    ...
    const errors = { ...this.state.errors };
    if (validationErrors) {
      this.props.enqueueSnackbar("Please fill out the fields properly.", { variant: "error" });
    ...
    try {
      ...
      if (ex.response) this.props.enqueueSnackbar(ex.response.data.errors[0], { variant: "error" });
